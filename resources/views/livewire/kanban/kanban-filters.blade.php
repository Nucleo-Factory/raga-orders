...
>
    ...
    <div
        ...
        class="absolute right-0 z-50 mt-2 w-72 origin-top-right rounded-md bg-white p-4 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
        style="display: none;"
    >
        ...
        <div class="space-y-4">
            ...
            @if(count($currencies) > 0)
                <div>
                    ...
                    <select id="currency-filter" wire:model.live="selectedCurrency" class="mt-1 block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-indigo-500 focus:outline-none focus:ring-indigo-500">
            ...
            @if(count($incoterms) > 0)
                <div>
                    ...
                    <select id="incoterm-filter" wire:model.live="selectedIncoterm" class="mt-1 block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-indigo-500 focus:outline-none focus:ring-indigo-500">
            ...
            @if(count($plannedHubs) > 0)
                <div>
                    ...
                    <select id="planned-hub-filter" wire:model.live="selectedPlannedHub" class="mt-1 block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-indigo-500 focus:outline-none focus:ring-indigo-500">
            ...
            @if(count($actualHubs) > 0)
                <div>
                    ...
                    <select id="actual-hub-filter" wire:model.live="selectedActualHub" class="mt-1 block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-indigo-500 focus:outline-none focus:ring-indigo-500">
            ...
            @if(count($materialTypes) > 0)
                <div>
                    ...
                    <select id="material-type-filter" wire:model.live="selectedMaterialType" class="mt-1 block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-indigo-500 focus:outline-none focus:ring-indigo-500">
        ...
        <div class="mt-5 flex justify-between border-t border-gray-200 pt-4">
            <button
