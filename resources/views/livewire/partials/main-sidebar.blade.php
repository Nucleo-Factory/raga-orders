...
<sidebar
    class="main-sidebar fixed left-0 top-0 z-10 grid h-full max-h-[1000px] grid-rows-[auto_1fr_auto] rounded-br-[1.25rem] rounded-tr-[1.25rem] bg-white font-inter text-[0.875rem] transition-none sm:static">
