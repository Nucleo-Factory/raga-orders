        ...
        <ul class="space-y-2">
            <li>
                <x-sidebar-link href="{{ route('dashboard') }}"
                    class="{{ $url === route('dashboard') ? 'bg-[#E0E5FF]' : '' }}">
                    <div class="flex h-5 w-5 items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 18 17"
                            fill="none">
                            <path
                                class="{{ $url === route('dashboard') ? 'fill-[#565AFF]' : 'group-hover:fill-black fill-[#898989]' }} transition-colors duration-500"
            ...
            <li>
                <x-sidebar-link href="{{ route('purchase-orders.kanban-boards') }}"
                    class="{{ $url === route('purchase-orders.kanban-boards') ? 'bg-[#E0E5FF]' : '' }}">
                    <div class="flex h-5 w-5 items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="18" viewBox="0 0 16 20"
                            ...
                            <path
                                ...
                                class="{{ $url === route('purchase-orders.kanban-boards') ? 'fill-[#565AFF]' : 'group-hover:fill-black fill-[#898989]' }} transition-colors duration-500" />
                            <path
                    ...
                    <div
                        class="link-text {{ $url === route('purchase-orders.kanban-boards') ? 'text-[#565AFF]' : 'group-hover:text-black' }} transition-colors duration-500">
            ...
            <li>
                <x-sidebar-link href="{{ route('products.create') }}"
                    class="{{ $url === route('products.create') ? 'bg-[#E0E5FF]' : '' }}">
                    <div class="flex h-5 w-5 items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="18" viewBox="0 0 18 20"
                            ...
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                class="{{ $url === route('products.create') ? 'fill-[#565AFF]' : 'group-hover:fill-black fill-[#898989]' }} transition-colors duration-500" />
                            <path
                    ...
                    <div
                        class="link-text {{ $url === route('products.create') ? 'text-[#565AFF]' : 'group-hover:text-black' }} transition-colors duration-500">
                        <span>Inicio</span>
                    </div>
                </x-sidebar-link>
            </li>
